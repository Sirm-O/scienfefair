...
export type SubCountyAdminView = 'dashboard' | 'judges' | 'projects' | 'rankingReport' | 'summaryReports' | 'judgingReports';

interface SidebarProps {
  activeView: SubCountyAdminView;
