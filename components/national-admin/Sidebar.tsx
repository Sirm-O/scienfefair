...
export type NationalAdminView = 'dashboard' | 'regionalAdmins' | 'judges' | 'projects' | 'rankingReport' | 'summaryReports' | 'judgingReports';

interface SidebarProps {
  activeView: NationalAdminView;
