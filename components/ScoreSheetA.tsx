...
import { PART_A_CRITERIA } from '../constants';
...
const ScoreSheetA: React.FC<ScoreSheetProps> = ({ scores, onScoreChange }) => {
  return (
    <div>
      <h3 className="text-xl font-bold mb-4">Part A: Written Communication (30 Marks)</h3>
      <div className="overflow-x-auto bg-white dark:bg-gray-800 shadow-md rounded-lg">
        <table className="w-full text-sm text-left text-gray-700 dark:text-gray-300">
          ...
          <tbody>
            {PART_A_CRITERIA.map((criterion, index) => (
              <CriterionRow 
                key={criterion.id}
                criterion={criterion}
