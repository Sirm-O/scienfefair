...
export type CountyAdminView = 'dashboard' | 'subCountyAdmins' | 'judges' | 'projects' | 'rankingReport' | 'summaryReports' | 'judgingReports';

interface SidebarProps {
  activeView: CountyAdminView;
      ...
      <nav className="space-y-2">
        ...
        <p className="px-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Management</p>
         <NavItem
          ...
          label="Sub-County Admins"
          isActive={activeView === 'subCountyAdmins'}
